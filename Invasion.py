...
land_s.set_volume(1.5)
spin_s.set_volume(0.6)
jump_s.set_volume(2.0)
...
while True:
    ...
    outlined_text(bg_font, main_font, 'Camada - ' + str(level), display, (8, 5))
    outlined_text(bg_font, main_font, str(enemy_count - enemies_left) + '/' + str(enemy_count), display, (8, 15))

    outlined_text(bg_font, main_font, 'Clique esquerdo: Ataque', display, (instructions_pos - main_font.width('Clique esquerdo: Ataque') // 2, 110))
    outlined_text(bg_font, main_font, 'Clique direito: Saltar', display, (instructions_pos - main_font.width('Clique direito: Saltar') // 2, 120))
    outlined_text(bg_font, main_font, 'Extinguir:', display, (instructions_pos - main_font.width('Extinguir:') // 2, 15))
